...
<%@ page import="java.util.List, model.Tarefa, java.sql.Timestamp"%>
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="flex-shrink-0 dropdown">
          ...
          <ul class="dropdown-menu text-small shadow">
            <li><a class="dropdown-item" href="/Atv_Pratica14_EnzoMb_DW1/logout">Logout</a></li>
          </ul>
        </div>
      </div>
    </div>
	...
	%>
        <div class="col">
          <div class="card shadow-sm">
            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em"><%= tarefa.getTitulo() %></text></svg>
            <div class="card-body">
              <p class="card-text"><%= tarefa.getDescricao() %></p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="/Atv_Pratica14_EnzoMb_DW1/mostraTarefa?id_tarefa=<%= tarefa.getId_tarefa() %>"><button type="button" class="btn btn-sm btn-outline-secondary">Editar</button></a>
                  <a href="/Atv_Pratica14_EnzoMb_DW1/removeTarefa?id_tarefa=<%= tarefa.getId_tarefa() %>&id_usuario=${ id_usuario }"><button type="button" class="btn btn-sm btn-outline-secondary">Remover</button></a>
                </div>
                <small class="text-body-secondary">Criação: <br><%= tarefa.getData_criacao() %></small>
                <small class="text-body-secondary">Conclusão: <br><%= tarefa.getData_conclusao() %></small>
              </div>
            </div>
          </div>
  ...
  %>
  		...
  		<div align="center">
		<a href="/Atv_Pratica14_EnzoMb_DW1/registerTarefa?id_usuario=${ id_usuario }"><button type="button" class="btn btn-sm btn-outline-secondary" style="font-size: 50px; text-decoration: none; border-radius: 30%;">+</button></a>
		<br>
		Usuario: ${ id_usuario }
	</div>
    </div>
